...
import com.mentor.action.BWFL_import_permit_reportAction;
import com.mentor.resource.ConnectionToDataBase;
import com.mentor.utility.Constants;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Utility;

public class BWFL_import_permit_reportImpl {

	// =======================print report=================================

	public void printReport(BWFL_import_permit_reportAction act)
	{
	...
	reportQuery =   
	                ...
	                " select  a.app_id , permit_nmbr ,digital_sign_date, sum(b.no_of_cases) as cases , c.gatepass_no , c.dispatch_date as gatepass_date , sum(c.int_boxes) as dis_cases, d.description from  "+
	                " bwfl_license.import_permit_20_21 a, bwfl_license.import_permit_dtl_20_21 b, bwfl_license.mst_bottling_plan_20_21 c, district d                                                   "+
	                " where a.app_id =b.app_id and a.vch_approved ='APPROVED' and digital_sign_date is not null and a.permit_nmbr =c.permitno  "+
	                " "+filter+" and a.district_id =d.districtid and a.digital_sign_date BETWEEN '"+ Utility.convertUtilDateToSQLDate(act.getFromDate())+ "'" +
	                " AND '"+ Utility.convertUtilDateToSQLDate(act.getToDate())+ "'  and c.gatepass_no in (select gatepass from bwfl_license.mst_receipt_20_21) group by a.app_id , permit_nmbr ,digital_sign_date ,                                                                       "+
	                " c.gatepass_no,c.dispatch_date,d.description order by d.description,a.digital_sign_date";
			...
			if (rs.next()) {
				...
				jasperReport = (JasperReport) JRLoader.loadObject(relativePath + File.separator+ "bwfl_import_report.jasper");
				...
				JasperExportManager.exportReportToPdfFile(print,relativePathpdf + File.separator+ "bwfl_import_report" +  "_" + n + ".pdf");
				act.setPdfName("bwfl_import_report" + "_" +n + ".pdf");
	...
	public boolean writeExcel(BWFL_import_permit_reportAction act)
	{
		...
		try {			
			...
			cellhead0.setCellValue(" Report BWFL Import Permit " + " From " + " " + Utility.convertUtilDateToSQLDate(act.getFromDate())+ " " + 
			...
			fileOut = new FileOutputStream(relativePath+ "//ExciseUp//MIS//Excel//" + n + "_" +"-bwfl_import_report.xlsx");
			act.setExlname(n  + "_" + "-bwfl_import_report");
	...
	public ArrayList districtListImpl(BWFL_import_permit_reportAction act) {
	...
	public ArrayList deoDistrictListImpl(BWFL_import_permit_reportAction act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
