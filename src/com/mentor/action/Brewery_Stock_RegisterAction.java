...
import com.mentor.impl.Brewery_Stock_RegisterImpl;

public class Brewery_Stock_RegisterAction {


	Brewery_Stock_RegisterImpl impl = new Brewery_Stock_RegisterImpl();
	...
	public void print()throws Exception {
		String st = "30/03/2019";
		Date date1 = new SimpleDateFormat("dd/MM/yyyy").parse(st);
		
	
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		if(this.fromDate != null && this.toDate != null && this.packId !=0){
			...
			FacesContext.getCurrentInstance().addMessage(
					...
					new FacesMessage(FacesMessage.SEVERITY_ERROR,
							"Select Brand and Date ", "Select Brand and Date "));
		}
