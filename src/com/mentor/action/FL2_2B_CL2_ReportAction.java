...
import com.mentor.impl.FL2_2B_CL2_ReportImpl;

public class FL2_2B_CL2_ReportAction {

	FL2_2B_CL2_ReportImpl impl = new FL2_2B_CL2_ReportImpl();
	...
	public void print() {
		...
		if(this.getFromDate().before(st) || this.getToDate().after(et))
		{	
