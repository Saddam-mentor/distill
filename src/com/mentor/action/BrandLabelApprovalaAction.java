...
import com.mentor.impl.BrandLabelApprovalImpl;

public class BrandLabelApprovalaAction {
    BrandLabelApprovalImpl impl = new BrandLabelApprovalImpl();
	...
	//	impl.printexcelSummary(this);
	    ...
	    else if (this.radio_type != null  && this.radio_type.equalsIgnoreCase("BL") )
	    {
