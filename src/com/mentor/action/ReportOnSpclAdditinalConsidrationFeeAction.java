...
import com.mentor.impl.ReportOnSpclAdditinalConsidrationFeeImpl;

public class ReportOnSpclAdditinalConsidrationFeeAction {
	...
	public void printReport() {
		if (this.fromDate != null && this.toDate != null) {
			new ReportOnSpclAdditinalConsidrationFeeImpl().printReport(this);
		}else{
	...
	public void excel() {
		if (this.fromDate != null && this.toDate != null) {
		new ReportOnSpclAdditinalConsidrationFeeImpl().writeExcel(this);
		}else{
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage("Select Date ","Select Date"));
		}
