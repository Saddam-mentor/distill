...
import com.mentor.impl.Bwfl_permit_tracking_impl;



public class Bwfl_permit_tracking_action {

	Bwfl_permit_tracking_impl impl = new Bwfl_permit_tracking_impl();
	...
	*/
	...
	/*public void printReport(ActionEvent e) {
		...
		Bwfl_permit_tracking_dt dt = (Bwfl_permit_tracking_dt) this.getDisplayRegUsers().get(uiTable.getRowIndex());
