		...
		<h:form style="background-color:whitesmoke;">
			...
			<div class="form-group">
				...
				<div class="row " align="center">
					...
					<h:inputHidden
									value="#{stockReportFL2Action.hidden}"></h:inputHidden>
						<h2>
					...
					<div>
					<h:outputLabel
									value="#{stockReportFL2Action.applicant_name}"
				...
				<div class="col-md-12" align="center">
					...
					<div class="col-md-3" align="left">
						<h:selectOneMenu
							...
							value="#{stockReportFL2Action.packId}"
							style="width: 250px; height: 28px;" >
							<f:selectItems
								value="#{stockReportFL2Action.brandList}" />
						</h:selectOneMenu>
					</div>
				</div>
				...
				<div class="col-md=12" align="center">
					...
					<div class="col-md-2" align="left">
						<rich:calendar value="#{stockReportFL2Action.fromDate}">
						</rich:calendar>
					</div>
					<div class="col-md-1" align="right">To:</div>
					<div class="col-md-2" align="left">
						<rich:calendar value="#{stockReportFL2Action.toDate}">
						</rich:calendar>
					</div>
					<div class="col-md-3"></div>
				</div>
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{stockReportFL2Action.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/MIS/pdf/#{stockReportFL2Action.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{stockReportFL2Action.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{stockReportFL2Action.reset}">
					</h:commandButton>
				</div>
				<br />
