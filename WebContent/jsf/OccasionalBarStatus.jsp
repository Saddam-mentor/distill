			...
			<div class="form-group">
				...
				<div class="row " align="center">
					<div align="center" width="100%" class="pghead">
						<h2>
							<h:outputText value=" Status Of Occasional Bar "
				...
				<div class="col-md=12" align="center">
					...
					<div class="col-md-2" align="left">
						<rich:calendar value="#{occasionalBarStatusAction.fromDate}">
						</rich:calendar>
					</div>
					<div class="col-md-1" align="right">To:</div>
					<div class="col-md-2" align="left">
						<rich:calendar value="#{occasionalBarStatusAction.toDate}">
						</rich:calendar>
					</div>
					<div class="col-md-3"></div>
				</div>
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{occasionalBarStatusAction.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/MIS/pdf/#{occasionalBarStatusAction.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{occasionalBarStatusAction.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{occasionalBarStatusAction.reset}">
					</h:commandButton>
				</div>
				<br />
