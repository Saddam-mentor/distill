			...
			<div class="form-group">
				...
				<div class="row " align="center">
					<div align="center" width="100%" class="pghead">
						<h2>
							<h:outputText value="Fl2D Stock Register" 
				...
				<div class="row " align="center">
					...
					<h:inputHidden
									value="#{fl2D_Stock_Register_Action.hidden}"></h:inputHidden>
				</div>
				...
				<div class="col-md=12" align="center">
					...
					<div class="col-md-2" align="left">
						<rich:calendar 
						value="#{fl2D_Stock_Register_Action.fromDate}"
						
					
							onchanged="this.form.submit()"
							
						valueChangeListener="#{fl2D_Stock_Register_Action.dateCheck}"
						>
						</rich:calendar>
					</div>
					...
					<div class="col-md-2" align="left">
						...
						value="#{fl2D_Stock_Register_Action.toDate}"
						>
						</rich:calendar>
					</div>
					<div class="col-md-3"></div>
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{fl2D_Stock_Register_Action.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/MIS/pdf/#{fl2D_Stock_Register_Action.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{fl2D_Stock_Register_Action.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{fl2D_Stock_Register_Action.reset}">
					</h:commandButton>
				</div>
				<br />
