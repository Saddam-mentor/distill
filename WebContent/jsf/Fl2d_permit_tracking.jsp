	...
	border: 1px solid #669999;
		...
		<h:form>
			<div class="container">
									...
									<TBODY>
										...
										<tr>
											<TD align="center" colspan="2"><h2>
													<h:outputText value="FL2D Permit Tracking"
				...
				<h:panelGroup
					rendered="#{fl2d_permit_tracking_action.hideDataTable and !fl2d_permit_tracking_action.showMainPanel_flg}">
												...
												<TBODY align="center">
													...
													<tr>
														<TD colspan="2" align="center" style="COLOR: #2952a3; ; 
														 font-family:Times New Roman">Enter Permit Number : <h:inputText 
																value="#{fl2d_permit_tracking_action.permit_no}"
													...
													<TR align="center">
														<td style="text-align: center;"><h:commandButton
																...
																action="#{fl2d_permit_tracking_action.viewDetails}">
															</h:commandButton>
															<rich:spacer width="10px"></rich:spacer>
																<h:commandButton styleClass="btn btn-sm btn-danger"
																	action="#{fl2d_permit_tracking_action.reset}" value="Reset"></h:commandButton></td>
													</TR>
				...
				<div class="container-fuild">
					<h:panelGroup rendered="#{fl2d_permit_tracking_action.viewPanelFlg}">
						<div class="row" align="center">
              <rich:spacer height="20px" />
								...
								<table align="center" width="100%;">
                                 ...
                                 <tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												...
												value="#{fl2d_permit_tracking_action.permitDate}" style=" height : 28px;">
											</h:inputText></td>
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												disabled="true" styleClass="inputtext"
												value="#{fl2d_permit_tracking_action.licenseNmbr}">
											</h:inputText></td>
										<td
											style="width: 110px; text-align: center; padding: 8px 16px;"><h:outputText
										...
										<td style="width: 200px; padding: 8px 16px;"><h:selectOneRadio
												...
												value="#{fl2d_permit_tracking_action.byRoad_byRoute}">
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{fl2d_permit_tracking_action.routeDetail}">
											</h:inputTextarea></td>
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{fl2d_permit_tracking_action.parentUnitNm}">
											</h:inputTextarea></td>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{fl2d_permit_tracking_action.parentUnitAdrs}">
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												disabled="true" styleClass="inputtext"
												value="#{fl2d_permit_tracking_action.parentUnitState}"></h:inputText></td>
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												disabled="true" styleClass="inputtext"
												value="#{fl2d_permit_tracking_action.parentUnitState}">
											</h:inputText></td>
										<td style="width: 100px; padding: 8px 16px;"><h:outputText
										...
										<td colspan="2" style="padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{fl2d_permit_tracking_action.consignorNmAdrs}" /></td>
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:selectOneRadio
												style="width:80%" disabled="true"
												value="#{fl2d_permit_tracking_action.mapped_unmapped}">
									...
									<div class="row" align="center">
										<div class="col-md-12">
											<rich:dataTable id="table2p" width="100%"
												value="#{fl2d_permit_tracking_action.displayBrandDetails}"
												...
												<rich:column rendered="#{!fl2d_permit_tracking_action.fl2dDutyFlg}">
													<f:facet name="header">
													...
													<f:facet name="footer">
														<h:outputText id="totalduty"
															value="#{fl2d_permit_tracking_action.totalDuty}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
												...
												<rich:column>
													...
													<f:facet name="footer">
														<h:outputText id="totalfees"
															value="#{fl2d_permit_tracking_action.totalImportFee}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
												...
												<rich:column>
													...
													<f:facet name="footer">
														<h:outputText id="totspclfees"
															value="#{fl2d_permit_tracking_action.totalSpecialFee}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
				...
				<h:panelGroup
					rendered="#{fl2d_permit_tracking_action.viewPanelFlg}">
						...
						<div class="row" align="center">
							<div class="col-md-12">
								<rich:dataTable id="table3" width="100%"
									value="#{fl2d_permit_tracking_action.displayChalanDetails}" var="list"
					...
					<h:commandButton styleClass="btn btn-sm btn-info"
					 action="#{fl2d_permit_tracking_action.close}" value="Close"></h:commandButton>
					</div>
				</h:panelGroup>
