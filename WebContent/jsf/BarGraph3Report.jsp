...
<head>
  ...
  <script type="text/javascript" src="https://www.upexciseonline.in/doc/ExciseUp/graphjs/graphToday.js"></script>
  </head>
...
<f:view>
  ...
  <div align="center">
   ...
   <h:commandButton value="Today" action="#{barGraphAction.currentDay}"></h:commandButton>
