	...
	<f:view>
		<h:form style="background-color:whitesmoke;">
			...
			<div class="form-group">
				...
				<div class="row">
					<div align="center">
						<h:outputText value="Approved Labels Report"
				...
				<div class="row col-md-12" align="center"
					...
					<div class="col-md-12" align="center">
						<h:selectOneRadio
							...
							value="#{approvedLabelsReportAction.radio}"
							valueChangeListener="#{approvedLabelsReportAction.radioListener}"
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{approvedLabelsReportAction.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/MIS/pdf/#{approvedLabelsReportAction.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{approvedLabelsReportAction.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{approvedLabelsReportAction.reset}">
					</h:commandButton>
				</div>
