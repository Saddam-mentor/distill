...
<head>
  ...
  <script type="text/javascript" src="https://www.upexciseonline.in/doc/ExciseUp/graphjs/graphTotalPaiFL.js"></script>
  </head>
  ...
  <div class="row" align="center">
      ...
      <div><rich:spacer height="30px"></rich:spacer>
       ...
       <div class="col-md-2" align="center"></div>
		...
		<div class="col-md-4"  id="BarChart5" style="border: 1px solid #ccc"></div>
		<div class="col-md-1" align="center"></div>
        <div class="col-md-4"  id="BarChart6" style="border: 1px solid #ccc"></div>
      </div>
