			...
			<div class="form-group">
				...
				<div class="row " align="center">
					<div align="center" width="100%" class="pghead">
						<h2>
							<h:outputText value="Unit Wise Dispatches to WholeSale (in Cases)"
				...
				<div class="row " align="center">
                   ...
                   <rich:spacer width="20px"></rich:spacer>
					<h:selectOneMenu
						value="#{saleInCasesAction.year}"
						style="height: 25px; width : 150px;">
						<f:selectItems
							value="#{saleInCasesAction.getAll_List}"/>
					</h:selectOneMenu>
				</div>
				</div>
                 <rich:spacer height="30px"></rich:spacer>
				<div class="row col-md-12" align="center"
					...
					<div class="col-md-12" align="center">
						<h:selectOneRadio
							...
							value="#{saleInCasesAction.radio}"
							valueChangeListener="#{saleInCasesAction.radioListener}"
				...
				<div class="col-md=12" align="center">
					...
					<div class="col-md-2" align="right">Date:</div>
					<div class="col-md-4" align="left">
						<rich:calendar value="#{saleInCasesAction.date}">
						</rich:calendar>
					</div>
					<div class="col-md-3"></div>
				</div>
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{saleInCasesAction.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/MIS/pdf/#{saleInCasesAction.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{saleInCasesAction.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{saleInCasesAction.reset}">
					</h:commandButton>
				</div>
				<br />
				<div class="col-md-12" align="center">
					<h:commandButton rendered="false" styleClass="btn btn-primary"
						action="#{saleInCasesAction.excel}" value="Generate Excel"
						 />

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp//MIS//Excel//#{saleInCasesAction.exlname}.xlsx"
						target="_blank">
						<h:outputText styleClass="outputText" value="Download Excel"
							rendered="#{saleInCasesAction.excelFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>
				</div>
