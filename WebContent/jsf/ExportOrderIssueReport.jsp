<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<f:view>
		...
		<h:inputHidden value="#{exportOrderIssueReportAction.hidden}" />
			<rich:separator lineType="dashed"></rich:separator>
			<div align="center">
				<h:outputText value="#{exportOrderIssueReportAction.name}"
			...
			<div class="form-group">
				...
				<div class="row " align="center">
					<div align="center" width="100%" class="pghead">
						<h2>
							<h:outputText value=" Report On Export Order Issue  "
				...
				<div class="col-md=12" align="center">
					...
					<div class="col-md-2" align="left">
						<rich:calendar value="#{exportOrderIssueReportAction.fromDate}">
						</rich:calendar>
					</div>
					<div class="col-md-1" align="right">To:</div>
					<div class="col-md-2" align="left">
						<rich:calendar value="#{exportOrderIssueReportAction.toDate}">
						</rich:calendar>
					</div>
					<div class="col-md-3"></div>
				</div>
				...
				<div class="row" align="center">
					<h:commandButton value="Print Report" styleClass="btn btn-success"
						action="#{exportOrderIssueReportAction.print}">
					</h:commandButton>

					<h:outputLink styleClass="outputLinkEx"
						value="/doc/ExciseUp/reports/#{exportOrderIssueReportAction.pdfName}"
						target="_blank">
						<h:outputText styleClass="outputText" id="text223"
							value="View Report"
							rendered="#{exportOrderIssueReportAction.printFlag==true}"
							style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
					</h:outputLink>

					<rich:spacer width="10px;"></rich:spacer>
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{exportOrderIssueReportAction.reset}">
					</h:commandButton>
				</div>
				<br />
